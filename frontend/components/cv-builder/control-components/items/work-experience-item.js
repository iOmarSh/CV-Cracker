                ...
                <div>
                    <div className="flex flex-col">
                        <div className="whitespace-pre-wrap">
                            <span className="text-[#E6E9EB] text-base font-bold">{itemWorkExperience.company}</span>,
                            <span className="text-[#9AA3A8] text-base italic">{itemWorkExperience.position}</span>
                        </div>
                    </div>
