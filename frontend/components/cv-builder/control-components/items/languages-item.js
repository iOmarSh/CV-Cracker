...
const LanguagesItem = ({ draggableId,
    index, languagesItem, type, keyData,
    ...
    return <NormalDraggable draggableId={draggableId} index={index} keyData={keyData} isScaled={false}>
        <div key={index}
                ...
                <div>
                    <div className="flex flex-col">
                        <div className="whitespace-pre-wrap">
                            <span
                                className="text-[#E6E9EB] text-base font-bold">{languagesItem.title}</span>
                        </div>
                    </div>
            ...
            <div className={"flex content-end items-center"}>
                <EyeComponent onClick={() => OnDisableItem(index)} isVisible={languagesItem.isShownInPreview} />
